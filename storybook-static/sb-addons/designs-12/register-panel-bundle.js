...
`+e.id,s=Yt.get(i);return s||(s=Ut(o.absoluteBoundingBox,e.absoluteBoundingBox),Yt.set(i,s)),[...s.map(n=>gr({guide:n,reverseScale:t})),...s.map(n=>mr({guide:n,reverseScale:t,fontSize:r}))]},Gt=A`
  .distance-line {
    shape-rendering: geometricPrecision;
    fill: none;
    opacity: 0;
...
`,no=o=>{if(!o||!o.link||o.link===void 0||o.link==="undefined")return null;let{link:e,timestamp:t,fileName:r}=o;return b`<a
  ...
  >
    ...
    `}getMetadata(){return{fileName:this.documentNode.name,timestamp:this.documentNode.lastModified,link:this.link}}connectedCallback(){super.connectedCallback(),this.documentNode&&(ot(this,_e,"f").call(this),this.selectedPage&&(this.__updateTree(this.selectedPage),this.resetZoom()))}updated(e){super.updated(e),e.has("documentNode")&&(ot(this,_e,"f").call(this),this.selectedPage&&(this.__updateTree(this.selectedPage),this.resetZoom())),e.has("renderedImages")&&this.__updateEffectMargins()}};_e=new WeakMap,rt=new WeakMap;co([E({type:Object,attribute:"document-node"})],j.prototype,"documentNode",void 0);co([E({type:Object,attribute:"rendered-images"})],j.prototype,"renderedImages",void 0);customElements.get("figspec-file-viewer")||customElements.define("figspec-file-viewer",j);customElements.get("figspec-frame-viewer")||customElements.define("figspec-frame-viewer",U);var Tr=new Set(["children","localName","ref","style","className"]),ho=new WeakMap,kr=(o,e,t,r,i)=>{let s=i?.[e];s===void 0||t===r?t==null&&e in HTMLElement.prototype?o.removeAttribute(e):o[e]=t:((n,c,a)=>{let d=ho.get(n);d===void 0&&ho.set(n,d=new Map);let l=d.get(c);a!==void 0?l===void 0?(d.set(c,l={handleEvent:a}),n.addEventListener(c,l)):l.handleEvent=a:l!==void 0&&(d.delete(c),n.removeEventListener(c,l))})(o,s,t)},Pr=(o,e)=>{typeof o=="function"?o(e):o.current=e};function $e(o=window.React,e,t,r,i){let s,n,c;if(e===void 0){let f=o;({tagName:n,elementClass:c,events:r,displayName:i}=f),s=f.react}else s=o,c=t,n=e;let a=s.Component,d=s.createElement,l=new Set(Object.keys(r??{}));class h extends a{constructor(){super(...arguments),this.o=null}t(g){if(this.o!==null)for(let x in this.i)kr(this.o,x,this.props[x],g?g[x]:void 0,r)}componentDidMount(){var g;this.t(),(g=this.o)===null||g===void 0||g.removeAttribute("defer-hydration")}componentDidUpdate(g){this.t(g)}render(){let{_$Gl:g,...x}=this.props;this.h!==g&&(this.u=w=>{g!==null&&Pr(g,w),this.o=w,this.h=g}),this.i={};let S={ref:this.u};for(let[w,Me]of Object.entries(x))Tr.has(w)?S[w==="className"?"class":w]=Me:l.has(w)||w in c.prototype?this.i[w]=Me:S[w]=Me;return S.suppressHydrationWarning=!0,d(n,S)}}h.displayName=i??c.name;let u=s.forwardRef((f,g)=>d(h,{...f,_$Gl:g},f?.children));return u.displayName=h.displayName,u}var po=$e(le,"figspec-frame-viewer",U,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"}),uo=$e(le,"figspec-file-viewer",j,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"});var qc=__STORYBOOK_API__,{ActiveTabs:Kc,Consumer:Jc,ManagerContext:Qc,Provider:ed,addons:Ee,combineParameters:td,controlOrMetaKey:od,controlOrMetaSymbol:rd,eventMatchesShortcut:id,eventToShortcut:sd,isMacLike:nd,isShortcutTaken:ad,keyToSymbol:ld,merge:cd,mockChannel:dd,optionOrAltSymbol:hd,shortcutMatchesShortcut:pd,shortcutToHumanString:ud,types:it,useAddonState:fd,useArgTypes:gd,useArgs:md,useChannel:vd,useGlobalTypes:yd,useGlobals:bd,useParameter:st,useSharedState:xd,useStoryPrepared:wd,useStorybookApi:_d,useStorybookState:fo}=__STORYBOOK_API__;var Nr=Object.defineProperty,ct=(o,e)=>()=>(o&&(e=o(o=0)),e),Rr=(o,e)=>{for(var t in e)Nr(o,t,{get:e[t],enumerable:!0})},Ce,go,mo,vo,dt=ct(()=>{Ce=({config:o,defer:e=!1})=>{let[t,r]=k(e?void 0:o.url),[i,s]=k(!1);return N(()=>{if(!e)return;let n=requestAnimationFrame(()=>{r(o.url)});return()=>cancelAnimationFrame(n)},[e,o.url]),N(()=>{s(!1)},[t]),p("div",{css:go},!i&&p(I,{css:mo},"Loading..."),p("iframe",{css:vo,src:t,allowFullScreen:o.allowFullscreen,onLoad:()=>s(!0)}))},go=P`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
